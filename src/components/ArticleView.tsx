        ...
        <div className="p-5">
            ...
            <div className="flex flex-col gap-2">
                    ...
                    (articles.map((data, index) => (
                        <div className="w-3/4 hover:scale-95 hover:cursor-pointer transition-all overflow-hidden relative mb-2 h-80" key={index} onClick={()=>{
                            ...
                            <div key={data._id} className="h-auto shadow-lg mb-4 p-4 bg-white">
                                ...
                                <p className="mt-2">{data.content.slice(0, 300)}</p>
                            </div>
